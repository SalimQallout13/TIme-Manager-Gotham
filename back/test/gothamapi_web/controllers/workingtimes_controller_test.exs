defmodule GothamapiWeb.WorkingtimesControllerTest do
  ...
  @update_attrs %{
    end: ~N[2021-10-27 16:19:00],
    start: ~N[2021-10-27 16:19:00]
  }
  ...
  describe "create workingtimes" do
    test "renders workingtimes when data is valid", %{conn: conn} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2021-10-26T16:19:00",
               "start" => "2021-10-26T16:19:00"
  ...
  describe "update workingtimes" do
    ...
    test "renders workingtimes when data is valid", %{conn: conn, workingtimes: %Workingtimes{id: id} = workingtimes} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2021-10-27T16:19:00",
               "start" => "2021-10-27T16:19:00"
             } = json_response(conn, 200)["data"]
    end
